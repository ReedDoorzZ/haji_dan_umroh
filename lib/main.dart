...
import 'About.dart';
import 'HukumHaji.dart';
import 'PengertianHaji.dart';
import 'PerbedaanHaji.dart';

void main() => runApp(TuntunanHajiDanUmroh());

class TuntunanHajiDanUmroh extends StatelessWidget {
  @override
      ...
      body: Container(
        child: ListView(
          children: <Widget>[
            ...
            GestureDetector(
              onTap: () {
                openNewScreen(context, PengertianHaji());
              },
              child: Container(
            ...
            GestureDetector(
              onTap: () {
                openNewScreen(context, HukumHaji());
              },
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 30.0, vertical: 15.0),
                height: 250.0,
            ...
            GestureDetector(
              onTap: () {
                openNewScreen(context, PerbedaanHaji());
              },
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: 30.0, vertical: 15.0),
                height: 250.0,
